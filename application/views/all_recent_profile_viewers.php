...
<section class="col-lg-9 col-md-9 nopad">
      ...
      <section class="about-user-details">
        <div class="mfSearch">
        <h4 class="col-md-6"><span aria-hidden="true" class="glyphicon glyphicon-user"></span>Recent Viewers <?php /*?><?php if($add_frnd_reqs) { ?>(<?php  echo count($add_frnd_reqs); ?>) <?php } ?><?php */?></h4>
        ...
        <li class="col-md-4">
			...
			//print_r($myfrnd);
			 if($myfrnd[0]['request_status'] == 'Y') 
				   { ?>
					   		     <div class="disc"><div class="dcBtn"><a href="javascript:void(0);" id="addFrnd<?php echo $req[0]['user_id']; ?>">Friends</a></div></div>
             
				<?php   }elseif( $myfrnd[0]['request_status'] == 'W'){ ?>
					   		     <div class="disc"><div class="dcBtn"><a href="javascript:void(0);" id="addFrnd<?php echo $req[0]['user_id']; ?>">Request Send</a></div></div>
         ...
         <?php } } else echo "No Recent Viewers found."?>        

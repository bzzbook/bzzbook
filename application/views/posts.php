   ...
   <figure class="col-lg-3 col-md-3 col-sm-4 col-xs-12 animate-plus" data-animations="pulse"  data-animation-when-visible="true"  data-animation-reset-offscreen="true"><a href="#"><img src="<?php echo base_url(); ?>images/logo.png" alt=""></a></figure>
    ...
    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
      <div class="curentUser">
        ...
        <a href="#" role="button"  class="dropdown-toggle userName" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Logged in as:<span>Jhon Smith</span></a>
  ...
  <div class="row">
    ...
    <section class="col-lg-6 col-md-6 col-sm-5 col-xs-12 coloumn2">
      <div class="updateStatus">
        ...
        <textarea cols="" rows="" class="form-control" placeholder="What's Buzzing?"></textarea>
        <div class="updateControls"> <a href="#">Post</a> <a href="#">Public</a> </div>
        <div class="clear"></div>
      </div>
      <div class="posts">
        <article>

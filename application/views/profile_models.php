  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
       ...
       <div id="selected_bc_friends"><div id="search_bc_frnd_wrapper"><input type="text" name="txtsearch" id="search_bc_friends" onkeyup="keyupevent_bc();" /><input type="hidden" id="added_bc_users" name="added_bc_users" /><div id="auto_bc_suggest"></div></div></div>
      </div>
      <div class="modal-body">

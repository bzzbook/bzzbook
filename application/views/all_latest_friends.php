<?php 
 $frnds = $this->friendsmodel->latest_frnds($limit = 0); 
?> 
<section class="col-lg-9 col-md-9 nopad">
      ...
      <section class="about-user-details">
        <div class="mfSearch">
        <h4 class="col-md-6"><span aria-hidden="true" class="glyphicon glyphicon-user"></span>Latest Friends<?php if($frnds) { ?>(<?php  echo count($frnds); ?>) <?php } ?></h4>
    ...
    <div class="groupEditBlock myfriends">
      <ul class="groupEditBlock"> 
           <?php if($frnds) { foreach($frnds as $req){ ?>    
        <li class="col-md-4">
        	<div class="fdblock">

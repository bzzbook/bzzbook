    ...
    <nav class="navbar navbar-static" id="navbar-example">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse bs-example-js-navbar-collapse">
          ...
          <div class="pull-right viewAs"><a href="javascript:void(0)" id="nfc-bar"  class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"><!--<i class="fa fa-globe fa-2x"></i>--><img class="buzzerhorn" src="<?php echo base_url()."images/hornlogo.png"; ?>" /></a><div class="count-wrap"><div id="ntfc_count"><?php echo $unread_count; ?></div></div>

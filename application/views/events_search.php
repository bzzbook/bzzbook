...
<form id="search_events" name="search_events" action="<?php echo base_url(); ?>company/search_events" method="post">
<div class="row">
...
<button class="btn btn-success" type="submit">Search Companies</button>          
       ...
       <?php
	  if(isset($search_result_events))
	  {
	   $this->load->view('company_search',$search_result_events);
}          ?> 
 </section>
      </section>

 ...
 <?php   
			       ...
			       //if($i<=1){ 
				   $com_user_data = $this->customermodel->profiledata($comments_details[$i]->cmt_by); 	  $hrsago = $this->customermodel->get_time_difference_php($comments_details[$i]->cmt_timestamp);

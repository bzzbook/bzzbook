              ...
              <input type="hidden" name="post_cur_tab" id="post_cur_tab" value="<?php if(isset($current_tab)) echo $current_tab; ?>" />
                <div role="tabpanel" class="tab-pane active" id="overview">
                  <div class="smallboxes col-md-8 col-md-offset-2">
                    ...
                    <form name="bus_form" method="post" enctype="multipart/form-data" action="<?php echo base_url().'company/add_bus_page/'.$cmp_id; ?>" > 
                ...
                <div role="tabpanel" class="tab-pane" id="education">
                  <div class="smallboxes col-md-8 col-md-offset-2">
                   <div class="create_page "> 
                   <form name="cmp_form"  method="post" enctype="multipart/form-data" action="<?php echo base_url().'company/add_cmp_page/'.$cmp_id; ?>">
                ...
                <div role="tabpanel" class="tab-pane" id="place">
                  <div class="smallboxes col-md-8 col-md-offset-2">
                    <div class="create_page "> 
                    <form name="brand_form"  method="post" enctype="multipart/form-data" action="<?php echo base_url().'company/add_brand_page/'.$cmp_id; ?>">      
                ...
                <div role="tabpanel" class="tab-pane" id="contact">
                  <div class="smallboxes col-md-8 col-md-offset-2">
                   <div class="create_page "> 
                   <form name="art_form"  method="post" enctype="multipart/form-data" action="<?php echo base_url().'company/add_art_page/'.$cmp_id; ?>">      
                ...
                <div role="tabpanel" class="tab-pane" id="family">
                  <div class="smallboxes col-md-8 col-md-offset-2">
                   <div class="create_page "> 
                   <form name="ent_form"  method="post" enctype="multipart/form-data" action="<?php echo base_url().'company/add_ent_page/'.$cmp_id; ?>">      
                    ...
                    <input type="text" placeholder="Name" required="required" name="ent_page_name" value="<?php echo set_value('ent_page_name') ?>">
                     ...
                     <input type="text" name="aud_interests" placeholder="Interests" value="<?php echo set_value('aud_interests'); ?>">
                     <label class="small_width">Age</label> 
                ...
                <div role="tabpanel" class="tab-pane" id="details">
                  <div class="smallboxes col-md-8 col-md-offset-2">
                   <div class="create_page ">      
                  <form name="cause_form"  method="post" enctype="multipart/form-data" action="<?php echo base_url().'company/add_cause_page/'.$cmp_id; ?>"> 
